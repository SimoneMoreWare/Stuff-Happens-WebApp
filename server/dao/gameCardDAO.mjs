...
/**
 * GameCardDAO - Data Access Object per la gestione delle carte in partita
 */
export default function GameCardDAO() {
     ...
     */
    this.addInitialCard = (game_id, card_id) => {
     ...
     * @returns {Promise<number>} - ID del GameCard creato
     */
    this.addRoundCard = (game_id, card_id, round_number) => {
        return new Promise((resolve, reject) => {
            const query = `
     ...
     */
    this.updateGuess = (gameCardId, guessed_correctly, position_guessed) => {
        return new Promise((resolve, reject) => {
            const now = dayjs().format('YYYY-MM-DD HH:mm:ss');
            const query = `
                UPDATE GameCards 
     ...
     */
    this.getCurrentRoundCard = (game_id, round_number) => {
        return new Promise((resolve, reject) => {
            const query = `
                SELECT * FROM GameCards 
     ...
     * @returns {Promise<number>}
     */
    this.countWrongGuesses = (game_id) => {
        return new Promise((resolve, reject) => {
